...
TEST(SearchTest, Present) {
  ...
  EXPECT_TRUE(str_search(haystack, "az") == haystack);
  EXPECT_TRUE(str_search(haystack, "t") == haystack + 4);
  EXPECT_TRUE(str_search(haystack, "tyuio") == haystack + 4);
}

TEST(SearchTest, NotPresent) {
  const char *haystack = "azertyuio";

  EXPECT_TRUE(str_search(haystack, "tyuiop") == NULL);
  EXPECT_TRUE(str_search(haystack, "tyuip") == NULL);
  EXPECT_TRUE(str_search(haystack, "azertyuiop^$") == NULL);
  EXPECT_TRUE(str_search(haystack, "qsd") == NULL);
}

TEST(SearchTest, WorstCase) {
  const char *haystack = "aaaaaaaaaaaaaaaaab";
  EXPECT_TRUE(str_search(haystack, "aaaaab") == haystack + 12);
}
...
TEST(SearchTest, Multiple) {
  ...
  EXPECT_TRUE(str_search(haystack, "aaa") == haystack);
}

TEST(SearchTest, LongNeedle) {
  const char *haystack = "aa";
  EXPECT_TRUE(str_search(haystack, "aaaaaaaaaaaaaaaaab") == NULL);
}
...
TEST(SearchFirstCharTest, Present) {
  ...
  EXPECT_TRUE(str_search_first_char(haystack, 'a') == haystack);
  EXPECT_TRUE(str_search_first_char(haystack, 'r') == haystack + 3);
}

TEST(SearchFirstCharTest, NotPresent) {
  const char *haystack = "azertayuiopa";
  EXPECT_TRUE(str_search_first_char(haystack, 'b') == NULL);
}
...
TEST(SearchLastCharTest, Present) {
  const char *haystack = "azertayuiopa";
  EXPECT_TRUE(str_search_last_char(haystack, 'a') == haystack + 11);
  EXPECT_TRUE(str_search_last_char(haystack, 'r') == haystack + 3);
}

TEST(SearchLastCharTest, NotPresent) {
  const char *haystack = "azertayuiopa";
  EXPECT_TRUE(str_search_last_char(haystack, 'b') == NULL);
}
